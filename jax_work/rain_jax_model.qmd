...
From here we can tailor our model to one that fits the specific problem at hand. In this case, we know we can't have negative amounts of rain. There are a couple of ways one could fix this but we will do the simplest thing and simply add a positive activation layer. 
...
print('Baseline Model Loss values')
pos_params, base_lossval = run_sgd(pos_model, pos_params, x, y, squared_loss)
```
